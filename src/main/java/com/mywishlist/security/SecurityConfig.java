    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/", "/index.html", "/styles.css", "/app.js", "/event.html", "/event.js", "/import.html", "/import.js").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/events/*/gifts").permitAll()
